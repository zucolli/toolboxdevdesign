...
// 301 redirects: old tool URLs → /ferramentas/SLUG
$_tool_slugs = [
    'slug-generator', 'hash-generator', 'argon2-generator', 'sha512-crc32-generator',
    'svg-optimizer', 'contrast-checker', 'url-encoder-decoder', 'url-parser',
    'color-palette-generator', 'json-formatter', 'base64-encoder', 'px-rem-converter',
    'csv-json', 'uuid-generator', 'sql-formatter', 'image-base64', 'image-placeholder',
    'css-box-shadow', 'css-gradient', 'password-generator', 'utm-builder',
    'bulk-utm-generator', 'roi-calculator', 'whatsapp-link', 'copy-generator',
    'ab-test-calculator', 'word-counter', 'lorem-ipsum', 'case-converter',
    'text-cleaner', 'qr-generator', 'meta-tags', 'my-ip',
];

if (in_array($path, $_tool_slugs, true)) {
    header('Location: /ferramentas/' . $path, true, 301);
    exit;
}
...
match ($path) {
    ...
    'ferramentas/slug-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/contrast-checker' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/hash-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/utm-builder' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/url-encoder-decoder' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/color-palette-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/url-parser' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/argon2-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/sha512-crc32-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/svg-optimizer' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/copy-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/json-formatter' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/roi-calculator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/whatsapp-link' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/bulk-utm-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/base64-encoder' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/px-rem-converter' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/css-box-shadow' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/css-gradient' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/password-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/word-counter' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/lorem-ipsum' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/case-converter' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/qr-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/meta-tags' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/my-ip' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/image-base64' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/image-placeholder' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/text-cleaner' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/csv-json' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/uuid-generator' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/sql-formatter' => (function () use (&$titulo, &$pageDescription, &$view) {
    ...
    'ferramentas/ab-test-calculator' => (function () use (&$titulo, &$pageDescription, &$view) {
