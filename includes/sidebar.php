<nav class="sidebar">
    ...
    <div class="sidebar-section">
        <button class="sidebar-label" data-key="conhecimento">
            Base de Conhecimento
            <svg class="sidebar-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <ul class="nav-list">
            <li>
                <a href="<?= BASE_URL ?>base-de-conhecimento" class="nav-link <?= ($path === 'base-de-conhecimento') ? 'active' : '' ?>">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
                    Todos os Artigos
                </a>
            </li>
            <li>
                <a href="<?= BASE_URL ?>carlos-zucolli" class="nav-link <?= ($path === 'carlos-zucolli') ? 'active' : '' ?>">
